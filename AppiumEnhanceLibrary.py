...
class AppiumEnhanceLibrary(object):
    ...
    def get_text(self, locator):
        ...
        See `introduction` for details about locating elements.
        """
        return self.apu._get_text(locator)
    ...
    def mouse_up_at(self, locator, xoffset, yoffset):
        """Support `mouse up at` for Selenium2Library. Right now use click
        off-line button to end mouse behaviour.
        ...
        ActionChains(self.apu._current_application()).\
            ...
            element, 1, 1).move_by_offset(xoffset, yoffset).click().perform()
